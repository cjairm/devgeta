...
| Subcommand   | Args / Flags                                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------ | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `review-run` | `--reviewer code\|document\|skill` (default `code`) | Runs every reviewer model configured in `review.reviewers` sequentially, headless, through OpenCode (`opencode run --agent <a> --format json [-m <provider/model>]`), against the current branch — one invocation is one round; the round cap lives in the agent-side loop, not here. `--reviewer` picks which reviewer agent runs (the same three choices the `dg ws` `R` keybinding offers); every configured model runs that same reviewer. With `review.reviewers` unset, one run uses OpenCode's own default model. Prints one line per reviewer (`<model, or "OpenCode default model"> → <outcome>`), then the journal ids still open (`open: n4 n7`, or `open: none`). An outcome is `APPROVE`, `REQUEST CHANGES`, or `NEEDS DISCUSSION` (parsed from the reviewer's last `**Status:**` line), `NO VERDICT` (the run finished but stated no verdict), or `ERROR(<reason>)` (the run itself failed — spawn failure, nonzero exit, timeout, or an OpenCode error event; never guessed from matching message text, since an unusable model and a wedged provider both surface the same generic OpenCode error). One reviewer failing never stops the ones after it. While a reviewer runs, a short progress line goes to stderr as it starts and as it resolves (position, label, outcome, elapsed time) — stdout is unaffected and stays exactly the contract above. Refuses to run on the default branch or a detached HEAD (both checked before any reviewer is launched, with an actionable `git switch -c <name>` error — a review diffs against the default branch and a journal is keyed by branch name, so neither state has anything to review or anywhere to record it; see [ADR-0018](decisions/ADR-0018-review-loop-refuses-the-default-branch.md)), and refuses a branch with no commits ahead of the default branch — nothing committed to review yet, checked the same way before any reviewer is launched; uncommitted changes don't count toward this, so the error says so explicitly rather than reading as lost work. |
