...
See [ADR-0022](decisions/ADR-0022-a-pr-review-targets-immutable-shas.md).
...
- `requested` is whether the authenticated GitHub user (`gh api user`) is named
  ...
  ([ADR-0021](decisions/ADR-0021-pr-review-trigger-is-a-polled-state-read.md) §3).
